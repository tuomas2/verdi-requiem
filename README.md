...
| | |
|---|---|
| `stemmat/stemma-*.pdf` | Kahdeksan stemmaa: S/A/T/B × I/II. Tahtinumero joka tahdin päällä, käynnissä olevan osan nimi joka sivun yläreunassa, latinan sanojen suomennos tavujen alla pienemmällä, ensimmäisellä sivulla **klikattava sisällysluettelo** (ja samat osat PDF:n kirjanmerkkeinä), ja sivun ylälaidassa päivä jona stemma viimeksi muuttui |
