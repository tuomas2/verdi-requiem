...
| II·9b's **notes**: the choir file reports five candidate differences (S t.27 and t.33, A t.40, T t.30 and t.36, B t.35), four of them a G against a G♭. Its source PDF uses a subset font with private codepoints, so the glyph method needs those accidentals identified by counting before it can arbitrate | [`2026-09-10-kuorotiedostot-ja-osan-i-savelet.md`](docs/tyopaivakirja/2026-09-10-kuorotiedostot-ja-osan-i-savelet.md), *What is left here* |
